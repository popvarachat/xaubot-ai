...
ALIASES = {
    # The canonical #24 workbook generated by backtest_01_smc_only.py uses
    # "Dir", "Entry", "Exit", and "SL" in its Trade Log sheet.
    "direction": {"direction", "dir", "side", "type", "signal", "trade_type"},
